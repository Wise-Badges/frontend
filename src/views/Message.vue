    ...
    <div class="maxi-form-container">
      ...
      <div class="form-container">
        ...
        <div class="navigation-form">
          <router-link class="router-item" :to="'/receiver/' + this.$route.params.id"
            ><span id="sec-btn">Previous</span></router-link
          >
          ...
          <router-link
            ...
            :to="
              '/receiver/' +
                ...
                '/' +
                this.$store.state.message[0].message
            "
          >
            <span id="prim-btn-twitter" class="twitter-btn" v-on:click="handleSubmitMessage"
              >Issue badge</span
            >
          </router-link>
        </div>
